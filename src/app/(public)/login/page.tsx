  ...
  return (
    <Card className="w-full max-w-md border-border bg-surface">
      ...
      <div className="mt-4 flex items-center gap-3">
        ...
        <span className="text-sm text-text-soft">o</span>
        <hr className="flex-1 border-border" />
      </div>

      <button
        onClick={handleGoogleLogin}
        className="mt-4 flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-surface px-4 py-2.5 text-sm font-medium text-text transition-colors hover:bg-background"
      >

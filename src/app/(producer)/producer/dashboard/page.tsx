...
export default function DashboardProducer() {
  ...
  const [seccionActiva, setSeccionActiva] = useState<"ajustes" | "scanner">("ajustes");
                ...
                <div className="bg-surface border-2 border-text p-6 space-y-5 shadow-[4px_4px_0px_0px_var(--color-text)]">
                  ...
                  <div className="pt-4 flex flex-col sm:flex-row gap-3">
                    ...
                    <button
                      ...
                      disabled={loadingAccion}
                      className="bg-accent text-black border-2 border-text px-4 py-2.5 font-mono text-xs font-black uppercase shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:translate-x-0.5 hover:translate-y-0.5 transition-all active:shadow-none"
                    >
